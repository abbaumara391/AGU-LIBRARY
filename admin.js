...
/* =========================================================  
   AGULIBRARY — RESULT & CERTIFICATION  
   ...
   IMPORTANT:  
   Subject and individual examination titles are displayed  
   inside the result, but they do NOT define the registration  
   price hierarchy.  
========================================================= */  
...
function setupResultExamHierarchy() {  
   ...
   *  
   * If your admin.html contains these IDs, they will also  
   * be supported:  
   *  
  ...
  /* -------------------------------------------------------  
     BUILD GROUPS FROM EXISTING EXAMINATIONS  
  ------------------------------------------------------- */  
  ...
  /* -------------------------------------------------------  
     INCLUDE CONFIGURED EXAMINATION TYPES  
  ------------------------------------------------------- */  
  ...
  if (singleFilter) {  
    ...
    singleFilter.innerHTML =  
      '<option value="">All examination groups</option>' +  
    ...
    const rebuild =  
      () => {  
        ...
        boardFilter.innerHTML =  
          '<option value="">All boards / organizations</option>' +  
...
function selectedResultHierarchy() {  
  ...
  /*  
   * Use separate filters when they exist.  
   */  
  ...
  /*  
   * Otherwise use the existing single dropdown.  
   */  
...
async function loadResults() {  
  ...
  list.innerHTML =  
    `  
      <div class="empty">  
        Loading permanent examination records...  
      </div>  
    `;  
  ...
  try {  
    ...
    /*  
     * -----------------------------------------------  
     * LOAD PERMANENT EXAMINATION ATTEMPTS  
     * -----------------------------------------------  
     */  
    ...
    console.error(  
      "AGULIBRARY result loading error:",  
      error  
    );  
                  ...
                  : `  
                    ...
                    >  
                      ...
                      ${  
                        passed  
                          ? "Not found"  
                          : "Not issued — student did not pass"  
                      }  
